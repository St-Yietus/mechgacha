...
[
    ...
    ArmsItem("st_yietus:rotborn_fist","ROTBORN FIST","A simple arm, covered in pitted armor and tipped with a large, gauntlet-like hand. Paired with a small remote manipulator for more delicate work. Its fist counts as a weapon whenever it is not equipped with another melee weapon. Slightly reduces the effects of debuffs."),
    ...
    Item("st_yietus:crescent_companion","CRESCENT COMPANION", "The moon-headed ghost of a fictional being has made its home in the systems of your mech. Gain the ability to create an aura around you that slows nearby enemies' cooldowns and cooling and mildly slows yours. Don't forget it or it'll fade away..."),
    ...
    PowerItem("st_yietus:divinity_tap","DIVINITY TAP","A bony, eerily pristine variant of the CURSEHEART ENGINE. Generates additional energy for each unique debuff affecting you. In addition, gain a toggled ability that greatly improves all stats, but creates exponentially increasing heat while active. You feel tired after using it.", stars=5),
])
